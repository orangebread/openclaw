...
const TEST_GATEWAY_TOKEN = "gw-token";

const GATEWAY_TOKEN_ENV_KEY = ["OPENCLAW", "GATEWAY", "TOKEN"].join("_");
const GATEWAY_PASSWORD_ENV_KEY = ["OPENCLAW", "GATEWAY", "PASSWORD"].join("_");
...
beforeEach(() => {
  delete process.env[GATEWAY_TOKEN_ENV_KEY];
  delete process.env[GATEWAY_PASSWORD_ENV_KEY];
  pluginHttpHandlers = [];
  cfg = {};
});
